...
const projects = [
  ...
  { n: '003', title: 'Бэкапы, устойчивые к шифровальщику', meta: 'STORAGE / 2026', desc: 'Резервное копирование 32 машин на три независимых узла. Взломанный гипервизор не может стереть свои копии. Развёрнуто из git за 4 дня.', tech: 'PROXMOX PBS · ANSIBLE', metric: '8 → 32 ПОД ЗАЩИТОЙ' },
  ...
  { n: '006', title: 'Восстановление контура за 18 часов', meta: 'NETWORK / 2026', desc: 'Полная потеря внешнего канала и всех публикаций. Поднял новый пограничный маршрутизатор и вернул 80+ сервисов, не трогая клиентские машины.', tech: 'LINUX · NFTABLES · BGP', metric: 'DOWN → UP: 18 Ч' },
];
